//            var fun;
//            var fun1 =  88.5 – (61.9 * G) + PA * [(26.7 * T) + (903 * V)] + 25;
//            var fun2 =  135.3 – (30.8 * G) + PA * [(10.0 * T) + (934 * V)] + 25;
//            var fun3 =  662 - (9.53 * G) + PA *[(15.91 * T) + (539.6 * V)];
//            var fun4 =  354 – (6.91 * G) + PA * [(9.36 * T) + (726 * V)];
...
function myFunction3(){ //kad kliknemo na radio button (id devojcice), pozivamo funkciju da dodeli ove vrednosti u izbor aktivnosti
                          //ovde je vrednost dodeljena na .name
...
function myFunction4(){ //kad kliknemo na radio button (id decaci), pozivamo funkciju da dodeli ove vrednosti u izbor aktivnosti
   ...
   //console.log(x4,y4,z4,q4) //kad kliknemo na radio button (id muskarci), pozivamo funkciju da dodeli ove vrednosti u izbor aktivnosti
}

    //var myValue ;

function onSelected(){    //odavde mi treba dodeliti vrednosti u formuku
   ...
   // console.log(value);
    ...
    //console.log(x3,y3,z3,q3) //kad kliknemo na radio button (id muskarci), pozivamo funkciju da dodeli ove vrednosti u izbor aktivnosti
}
